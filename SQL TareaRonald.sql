...
USE [jardineria]
GO
/****** Object:  Table [dbo].[cliente]    Script Date: 12/12/2024 22:14:40 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Cliente_England_Financiero]    Script Date: 12/12/2024 20:57:49 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Cliente_England_Financiero](
	[codigo_cliente] [int] NOT NULL,
	[codigo_empleado_rep_ventas] [int] NULL,
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Cliente_England_General](
	[codigo_cliente] [int] NOT NULL,
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Cliente_España_Financiero](
	[codigo_cliente] [int] NOT NULL,
	[codigo_empleado_rep_ventas] [int] NULL,
	[limite_credito] [decimal](18, 2) NULL,
PRIMARY KEY CLUSTERED 
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Cliente_España_General](
	[codigo_cliente] [int] NOT NULL,
	[nombre_cliente] [nvarchar](100) NULL,
	[nombre_contacto] [nvarchar](50) NULL,
	[apellido_contacto] [nvarchar](50) NULL,
...
INSERT INTO Cliente_España_General(
...
INSERT INTO Cliente_España_Financiero (
...
INSERT INTO Cliente_England_General
(
    codigo_cliente, nombre_cliente, nombre_contacto, apellido_contacto,
    telefono, fax, linea_direccion1, linea_direccion2, ciudad, region, codigo_postal
)
...
INSERT INTO Cliente_England_Financiero (
    codigo_cliente, codigo_empleado_rep_ventas, limite_credito
)
SELECT 
    codigo_cliente, codigo_empleado_rep_ventas, limite_credito
